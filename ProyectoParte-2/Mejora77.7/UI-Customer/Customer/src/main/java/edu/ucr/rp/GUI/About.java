...
public class About {
    ...
    public GridPane getGraphicalUserInterfaceAbout() {
        ...
        Label labelAbout = new Label("Aplicación control de inventarios 2020 \n"
                + " Desarrollado en: Apache NetBeans IDE 11.3 \n Lenguaje Java, version 14 \n 2020");
        labelAbout.setFont(Font.font("Rockwell", FontWeight.EXTRA_BOLD, FontPosture.REGULAR, 20));
        labelAbout.setTextFill(Color.DEEPSKYBLUE);
        about.add(labelAbout, 0, 1);
