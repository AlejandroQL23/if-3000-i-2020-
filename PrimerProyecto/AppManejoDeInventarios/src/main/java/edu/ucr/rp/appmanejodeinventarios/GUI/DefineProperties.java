...
public class DefineProperties {
    ...
    public DefineProperties(String fileName) {
        this.fileName = fileName;
    }
    
    /**
     * 
     * @return Nos da la GUI que nos permite definir crear el archivo con las propiedades y definir las mismas
     * @throws IOException 
     */
    public GridPane defineProperties() throws IOException {
        ...
        buttonSaveProperties.setOnAction((event) -> {
            object = new Object(comboBoxTool.getValue().toString(), saveObject.linesAccount(comboBoxTool.getValue().toString()) - 2,
                    textFieldProperties, labelProperties);
