...
////                Properties.add(textFieldDefineProperties.get(i).getText());
////                Atributes.add(labelDefineProperties.get(i).getText());
////            }
////
////            object = new Mercancia(comboBoxTool.getValue().toString(),
////                    saveObject.linesAccount(comboBoxTool.getValue().toString()) - 2, Properties, Atributes);
////           //-**********---------**************----------------******************-------------->> c cae
////            
