...
public class passwordGenerator {
    ...
    public String Lowers[] = {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "ñ", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"};
    ...
    public String generate() {
        String password = "";// en esta variable es donde concatenaremos la contraseña final

        // ciertas validaciones a tomar en cuenta en el ingeso de los datos
        if (minLength >= maxLength) {
            return "ALERTA!: No se puede realizar esta contraseña, revice los valores de tamaño y ejecute de nuevo";
        }// end if
        else if (minNumbers > maxLength || minUpperCase > maxLength || minSpecialChars > maxLength) {
            return "ALERTA!: No coinciden las cantidades entre caractares pedidos y el tamaño maximo ingresado,revice los valores de tamaño y ejecute de nuevo";
        }//end else if 
        ...
        //     return "La cantidad de caracteres especiales que necesita, no coincide con la cantidad de caracteres que tenemos disponibles";
            ...
            faltantes = y + (int) (Math.random() * (maxLength - x) - 1);// juega con los valores faltantes y el tamaño maximo
